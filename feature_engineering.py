...
def feature_engineering(X):
    ...
    Transforms the raw complaints DataFrame by:
      ...
      3. Creating a binary flag for the presence of a complaint narrative
      4. Creating binary flags from the 'Tags' column (Older American, Servicemember)
      5. Encoding 'Timely response?' as a binary numeric feature
      6. Dropping identifier, raw date, free-text, and target columns
    ...
    # ------------------------------------------------------------------
    # 3. Narrative flag: 1 if consumer provided a free-text narrative
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # 4. Tags: binary indicator columns
    ...
    # ------------------------------------------------------------------
    # 5. Timely response: Yes → 1, anything else → 0
    # ------------------------------------------------------------------
